...
/**
 * @api {get} /url Get text from photo
 * @apiName OCR_API
 * @apiGroup OCR
 *
 * @apiSuccess {object} recognitionResults Result of text analysing.
 */
...
/**
 * @api {post} /bing/v7.0/spellcheck Check for spelling issues
 * @apiName Spellcheck
 * @apiGroup Spellcheck
 *
 * @apiParam {string} text Text that needs to be checked for errors.
 *
 * @apiSuccess {object} flaggedTokens Result of spellchecking
 */
